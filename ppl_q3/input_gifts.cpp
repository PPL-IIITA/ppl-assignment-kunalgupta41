...
void gifting(The_Utility_Gifts x[])
	{
		...
		k=((rand())%15)+6;
		couple temp1;
		cout<<"randomly generated value of k is "<<k<<endl;
		f6<<"randomly generated value of k is "<<k<<endl;
		for(i=0;i<=59;i++)
		{
			for(j=i;j<=59;j++)
			{
		...
		f6<<"according to the happiness of the couples,most happy" <<k<<" couples and their happiness are"<<endl;
		for(i=0;i<k;i++)
		{
			cout<<cup[i].get_n_1()<<" "<<cup[i].get_n_2()<<" "<<cup[i].get_h()<<endl;
			f6<<cup[i].get_n_1()<<" "<<cup[i].get_n_2()<<" "<<cup[i].get_h()<<endl;
		}
		for(i=0;i<=59;i++)
		{
			for(j=i;j<=59;j++)
		...
		f6<<"according to the compatibility of the couples,most compatible "<<k<<" couples and their compatibility are "<<endl;
		for(i=0;i<k;i++)
		{
			cout<<cup[i].get_n_1()<<" "<<cup[i].get_n_2()<<" "<<cup[i].get_c()<<endl;
			f6<<cup[i].get_n_1()<<" "<<cup[i].get_n_2()<<" "<<cup[i].get_c()<<endl;
		}
