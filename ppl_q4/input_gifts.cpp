// THIS IS TO GENERATE A TEXT FILE CONTAINING k LEAST HAPPY COUPLES.THIS TXT FILE WILL THEN BE USED IN MAIN CLASS  #include "input_gifts.h"
#include <fstream>
#include <iostream>
#include <string>
#include <cstdlib>
...
void gifting(The_Utility_Gifts x[])
	{
		...
		int k;
		cout<<"randomly generated value of k is :"<<endl;
		k=((rand())%20)+5;
		cout<<k<<endl;
		...
		*/
		cout<<"the least k happy couples are:"<<endl;
		f7<<k<<endl;
		for(i=59;i>59-k;i--)

		{
			cout<<cup[i].get_n_1()<<" "<<cup[i].get_n_2()<<endl;
			f7<<cup[i].get_n_1()<<" "<<cup[i].get_n_2()<<endl;
		}
